...
const PROJECTS = [
  ...
  },
  {
    ...
    description:
      "A Machine Learning project that detects whether a news article is Real or Fake using NLP techniques and a Linear Support Vector Classifier (LinearSVC). Features TF-IDF vectorization, text preprocessing, WordCloud visualizations, and comprehensive model evaluation.",
    live: "https://github.com/jhaGagan0/Fake-News-Detection",
    repo: "https://github.com/jhaGagan0/Fake-News-Detection",
